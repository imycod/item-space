...
function translate() {
  ...
  const {globalI18n} = toRefs(themeConfig.value)

  const lang = globalI18n.value === 'zh-cn' ? 'en' : 'zh-cn'
...
<template>
  <div class="grid">
    <div class="col-12 md:col-6">
      <div class="card">
        <h5>Default</h5>
        <Button label="translate" class="mr-2 mb-2" @click="translate">{{ $t('user.title1') }}</Button>
    ...
    <div class="col-12 md:col-6">
      ...
      <div class="card">
        ...
        <Button type="button" class="mr-2 mb-2" label="Search" icon="pi pi-search" :loading="loading[0]"
                @click="load(0)"/>
        <Button type="button" class="mr-2 mb-2" label="Search" icon="pi pi-search" iconPos="right" :loading="loading[1]"
                @click="load(1)"/>
